...
const projects = [
	{
		id: 1,
		image: images.ridealong,
		heading: "RideAlong",
		description:
			"<Also>Share rides and connect with people in your network.<p/> <br/> <p>A Cross-Platform car-pooling mobile application that aims to create a community around each institution</p>",
		technology: [
			"nodejs",
			"express",
			"mongodb",
	...
	{
		id: 2,
		image: images.paraplay,
		heading: "Parallel Player",
		description:
			"Watch videos together with your friends in sync from popular platforms and file paths",
		websiteLink: "https://paraplay.netlify.app/",
		githubLink: "https://github.com/PriyanKishoreMS/Paraplay",
		technology: ["nodejs", "express", "socketio", "react", "js"],
	},
	// {
	// 	id: 3,
				...
				{projects.map(proj => (
					...
					>
						...
						<div className='w-full z-10 md:w-1/2'>
							...
							<div className='flex flex-wrap items-center gap-3 md:gap-4 py-6'>
								{stack.map((tech, index) => (
									<>
										{proj.technology.includes(tech) && (
											<div
												key={index}
