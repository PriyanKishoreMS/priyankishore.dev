...
export default function NavBar() {
	...
	return (
		<Popover
			className={` ${
				addBlur && "drop-shadow-lg backdrop-blur-md bg-black bg-opacity-30"
		...
		>
			<motion.div
				...
				className='container'
			>
				<div className='flex justify-end items-center px-0 py-1 pb-6 gap-4 sm:px-6 lg:py-4 lg:pb-8 lg:gap-10'>
					<div className='mr-auto'>
						<a href='#home'>
							...
							<h3 className='md:text-4xl text-3xl font-bold text-primary dark:text-white'>
								PK
							</h3>
						</a>
					</div>
